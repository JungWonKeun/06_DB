...
-- 계정 생성
CREATE USER SPRING_JWK IDENTIFIED BY SPRING1234;

-- 권한 부여
GRANT CONNECT, RESOURCE TO SPRING_JWK;

-- 테이블 저장 공간 할당
ALTER USER SPRING_JWK
...
CREATE TABLE "MEMBER"(
		...
		"MEMBER_DEL_FL"		CHAR(1) DEFAULT 'N', -- 삭제여부
...
UPDATE "MEMBER"
SET 
	"MEMBER_PW" = '$2a$10$LxT345RcLHMEJ3hPw1DZZuDh8rUACl7eklYqNCqMPIQOcXi2DJ2FK'
WHERE 
	"MEMBER_NO"=1;
